...
let colors = ['#FFB900','#69797E','#847545','#E74856','#0078D7']
...
class Leaderboard extends Component {
	...
	getData() {
		...
		const request = new Request('http://127.0.0.1:8080/leaders');
		fetch(request)
	...
	render() {
		return (
			<div className="Leaderboard">
				...
				<div className="leaders">
					{this.state.data ? (
						this.state.data.map((el, i) => (
							<div key={el.id} style={{ 	animationDelay: i * 0.1 + 's' }} className="leader"	>
								<div className="leader-wrap">
									{i < 3 ? (
										<div style={{backgroundColor:colors[i%5]}}	className="leader-ava">
											<svg fill="#fff" xmlns="http://www.w3.org/2000/svg" height={24} width={24} viewBox="0 0 32 32">
									...
									<div className="leader-content">
										...
										<div className="leader-score">
											<svg fill="currentColor" height="20" viewBox="0 0 493 493" version="1.1" xmlns="http://www.w3.org/2000/svg">
				...
				<p>Leaderboard Updated After Every 5 Minutes</p>
			</div>
		);
	}
}
